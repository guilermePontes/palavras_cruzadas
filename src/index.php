...
<body>
  ...
  <h3>Across</h3>
  <p>7: The default language for android
    <button>Reveal</button><span>java</span></p>
  <p>16: The natural state of a metal e.g Iron-
    <button>Reveal</button><span>ore</span></p>
  <h3>Down</h3>
  <p>3: natural chamber in the ground or inside of a hill where you can enter
    <button>Reveal</button><span>cave</span></p>
  <p>10: To do, the take part in a movie
    <button>Reveal</button><span>act</span></p>
  <p>16: |, ||, this is used in programming, opposite of "and"
